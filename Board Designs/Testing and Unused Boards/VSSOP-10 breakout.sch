...
<wire x1="-1.05" y1="1.2" x2="1.55" y2="1.2" width="0.127" layer="21"/>
<wire x1="1.55" y1="1.2" x2="1.55" y2="-1.2" width="0.127" layer="21"/>
<wire x1="1.55" y1="-1.2" x2="-1.05" y2="-1.2" width="0.127" layer="21"/>
<wire x1="-1.05" y1="-1.2" x2="-1.05" y2="1.2" width="0.127" layer="21"/>
<circle x="-0.75" y="-0.9" radius="0.15" width="0" layer="51"/>
<smd name="1" x="-0.75" y="-1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="2" x="-0.25" y="-1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="3" x="0.25" y="-1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="4" x="0.75" y="-1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="7" x="0.75" y="1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="8" x="0.25" y="1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="9" x="-0.25" y="1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="10" x="-0.75" y="1.55" dx="0.34" dy="0.55" layer="1"/>
<text x="-1.756" y="-1.2999" size="1.016" layer="25" rot="R90">&gt;NAME</text>
<text x="2.956" y="-1.2999" size="1.016" layer="27" rot="R90">&gt;VALUE</text>
...
<rectangle x1="1.125" y1="1.25" x2="1.375" y2="1.65" layer="51"/>
<rectangle x1="1.125" y1="-1.65" x2="1.375" y2="-1.25" layer="51"/>
<smd name="6" x="1.25" y="1.55" dx="0.34" dy="0.55" layer="1"/>
<smd name="5" x="1.25" y="-1.55" dx="0.34" dy="0.55" layer="1"/>
</package>
<package name="1X05">
...
<text x="0.635" y="15.875" size="1.778" layer="95">&gt;NAME</text>
<text x="0.635" y="-2.54" size="1.778" layer="96">&gt;VALUE</text>
<pin name="A1" x="-2.54" y="12.7" visible="pin" length="short" direction="pas"/>
<pin name="A0" x="-2.54" y="10.16" visible="pin" length="short" direction="pas"/>
<pin name="ALERT" x="-2.54" y="7.62" visible="pin" length="short" direction="pas"/>
<pin name="SDA" x="-2.54" y="5.08" visible="pin" length="short" direction="pas"/>
<pin name="GND" x="20.32" y="5.08" visible="pin" length="short" direction="pas" rot="R180"/>
<pin name="VBUS" x="20.32" y="7.62" visible="pin" length="short" direction="pas" rot="R180"/>
<pin name="IN-" x="20.32" y="10.16" visible="pin" length="short" direction="pas" rot="R180"/>
<pin name="IN+" x="20.32" y="12.7" visible="pin" length="short" direction="pas" rot="R180"/>
<pin name="SCL" x="-2.54" y="2.54" visible="pin" length="short" direction="pas"/>
<pin name="VS" x="20.32" y="2.54" visible="pin" length="short" direction="pas" rot="R180"/>
</symbol>
<symbol name="M05">
...
<description>INA226 Current and Power Monitor with I2C Compatible Interface</description>
<gates>
<gate name="G$1" symbol="INA226" x="0" y="-15.24"/>
</gates>
<devices>
...
<parts>
<part name="U$1" library="HyTechDevices" deviceset="INA226" device=""/>
<part name="U$2" library="HyTechDevices" deviceset="INA226" device=""/>
<part name="JP1" library="HyTechDevices" deviceset="M05" device=""/>
<part name="JP2" library="HyTechDevices" deviceset="M05" device=""/>
<part name="JP3" library="HyTechDevices" deviceset="M05" device=""/>
<part name="JP4" library="HyTechDevices" deviceset="M05" device=""/>
</parts>
<sheets>
<sheet>
<plain>
...
<instances>
<instance part="U$1" gate="G$1" x="53.34" y="22.86" rot="R90"/>
<instance part="U$2" gate="G$1" x="76.2" y="22.86" rot="R90"/>
<instance part="JP1" gate="G$1" x="45.72" y="50.8" rot="R270"/>
<instance part="JP2" gate="G$1" x="68.58" y="50.8" rot="R270"/>
<instance part="JP3" gate="G$1" x="45.72" y="12.7" rot="R90"/>
<instance part="JP4" gate="G$1" x="68.58" y="12.7" rot="R90"/>
</instances>
<busses>
</busses>
<nets>
