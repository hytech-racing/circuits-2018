...
<symbols>
<symbol name="ELCON_PFC_2500">
<wire x1="0" y1="0" x2="0" y2="22.86" width="0.254" layer="94"/>
<wire x1="0" y1="22.86" x2="43.18" y2="22.86" width="0.254" layer="94"/>
<wire x1="43.18" y1="22.86" x2="43.18" y2="0" width="0.254" layer="94"/>
<wire x1="43.18" y1="0" x2="0" y2="0" width="0.254" layer="94"/>
<text x="10.16" y="17.78" size="2.54" layer="95">ELCON PFC 2500</text>
<pin name="HV+" x="-5.08" y="7.62" length="middle"/>
<pin name="HV-" x="-5.08" y="5.08" length="middle"/>
<pin name="GND" x="-5.08" y="17.78" length="middle"/>
<pin name="NEUTRAL" x="48.26" y="10.16" length="middle" rot="R180"/>
<pin name="HOT" x="48.26" y="7.62" length="middle" rot="R180"/>
<pin name="GROUND" x="48.26" y="5.08" length="middle" rot="R180"/>
<pin name="INTERLOCK" x="-5.08" y="15.24" length="middle"/>
</symbol>
<symbol name="GND">
...
<devicesets>
<deviceset name="ELCON_PFC_2500">
<gates>
<gate name="G$1" symbol="ELCON_PFC_2500" x="0" y="0"/>
</gates>
<devices>
<device name="">
<technologies>
...
<modules>
<module name="ACCUMULATOR" prefix="" dx="35.56" dy="25.4">
<ports>
<port name="MOLEX_IMPERIUM_HV-" side="right" coord="-5.08" direction="in"/>
<port name="MOLEX_IMPERIUM_HV+" side="right" coord="-7.62" direction="out"/>
<port name="SHUTDOWN_CIRCUIT_INT" side="right" coord="7.62" direction="out"/>
</ports>
<variantdefs>
</variantdefs>
<parts>
...
<module name="POWERSWITCH" prefix="" dx="30.48" dy="15.24">
<ports>
<port name="G1" side="bottom" coord="7.62" direction="nc"/>
<port name="H1" side="bottom" coord="5.08" direction="nc"/>
<port name="N1" side="bottom" coord="10.16" direction="nc"/>
<port name="G0" side="top" coord="7.62" direction="nc"/>
<port name="H0" side="top" coord="5.08" direction="nc"/>
<port name="N0" side="top" coord="10.16" direction="nc"/>
<port name="GND" side="left" coord="5.08" direction="out"/>
<port name="SW-" side="left" coord="-2.54" direction="out"/>
<port name="SW+" side="left" coord="-5.08" direction="in"/>
</ports>
<variantdefs>
</variantdefs>
<parts>
...
<module name="CHARGE_ECU" prefix="" dx="25.4" dy="30.48">
<ports>
<port name="CANL" side="left" coord="7.62" direction="io"/>
<port name="CANH" side="left" coord="5.08" direction="io"/>
<port name="12VSUPPLY" side="left" coord="12.7" direction="in"/>
<port name="GND" side="left" coord="10.16" direction="out"/>
<port name="SW_EN+" side="top" coord="7.62" direction="out"/>
<port name="GND2" side="right" coord="-7.62" direction="in"/>
<port name="ELCON_CH_ENABLE" side="right" coord="-5.08" direction="out"/>
<port name="LED" side="top" coord="10.16" direction="out"/>
</ports>
<variantdefs>
</variantdefs>
<parts>
...
<module name="CAP_BOARD" prefix="" dx="30.48" dy="20.32">
<ports>
<port name="HV+" side="bottom" coord="10.16" direction="in"/>
<port name="HV-" side="bottom" coord="12.7" direction="out"/>
<port name="DISCHARGE_DISABLE" side="right" coord="5.08" direction="in"/>
...
<parts>
<part name="U$1" library="HyTechSymbols" deviceset="ELCON_PFC_2500" device=""/>
...
<sheet>
<plain>
<text x="180.34" y="137.16" size="1.778" layer="91">To Grid</text>
<text x="152.4" y="134.62" size="1.778" layer="91">Normally Open Relay</text>
<text x="27.94" y="109.22" size="1.778" layer="91">To aux vehicle
CAN/power</text>
<text x="43.18" y="73.66" size="1.778" layer="91">Charge ECU communicates
...
<text x="27.94" y="147.32" size="2.54" layer="91">Charging in vehicle at Formula Hybrid</text>
</plain>
<moduleinsts>
...
<instance part="GND1" gate="1" x="127" y="88.9" rot="MR0"/>
<instance part="GND11" gate="1" x="152.4" y="129.54" rot="MR90"/>
...
<segment>
<portref moduleinst="POWERSWITCH" port="GND"/>
...
<segment>
<portref moduleinst="CHARGE_ECU" port="GND2"/>
...
<portref moduleinst="POWERSWITCH" port="H1"/>
...
<portref moduleinst="POWERSWITCH" port="G1"/>
...
<portref moduleinst="POWERSWITCH" port="N1"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="INTERLOCK"/>
<portref moduleinst="CHARGE_ECU" port="ELCON_CH_ENABLE"/>
...
<portref moduleinst="CHARGE_ECU" port="SW_EN+"/>
...
<segment>
<portref moduleinst="CHARGE_ECU" port="LED"/>
